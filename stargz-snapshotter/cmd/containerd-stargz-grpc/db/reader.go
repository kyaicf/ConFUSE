...
func NewReader(db *bolt.DB, sr *io.SectionReader, opts ...metadata.Option) (metadata.Reader, error) {
	...
	for _, d := range decompressors {
		...
		_, tocOffset, _, tocSize, err := d.ParseFooter(footer[fOffset:])
		if err != nil {
...
func (r *reader) GetFileName(id uint32) (string, error) {
	return "not implemnt", nil
}

func (r *reader) GetParentId(cid uint32) (pid uint32, rerr error) {
	return 0, nil
}

func (r *reader) KernelToc() *estargz.KernelToc {
	return nil
}
