...
replace (
	...
	github.com/containerd/stargz-snapshotter/nativeconverter => ../nativeconverter
	github.com/hanwen/go-fuse/v2 => ../go-fuse
	// github.com/containerd/containerd/ => ../containerd
	// github.com/containerd/containerd/archive/compression => ../containerd/archive/compression
	// Import local packages.
	test/containerd => ../containerd
)
