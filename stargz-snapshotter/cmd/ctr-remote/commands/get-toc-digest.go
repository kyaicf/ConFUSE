...
var GetTOCDigestCommand = cli.Command{
	...
	Action: func(clicontext *cli.Context) error {
		...
		_, tocOff, ktocOff, tocSize, err := decompressor.ParseFooter(footer)
		if err != nil {
		...
		toc, _, tocDgst, err := decompressor.ParseTOC(io.NewSectionReader(ra, tocOff, tocSize), ktocOff-tocOff, tocSize-ktocOff)
		if err != nil {
