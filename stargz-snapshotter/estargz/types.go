...
type Decompressor interface {
	...
	ParseFooter(p []byte) (blobPayloadSize, tocOffset, kernelTocOffset, tocSize int64, err error)
	...
	// and return it.
	ParseTOC(r io.Reader, estargzTocSize, kernelTocSize int64) (toc *JTOC, ktoc *KernelToc, tocDgst digest.Digest, err error)
}
